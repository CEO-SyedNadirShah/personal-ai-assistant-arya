...
st.set_page_config(page_title="ARYA Settings", page_icon="⚙️", layout="wide")

st.markdown("## 🛠️ ARYA Settings")
st.caption("Customize ARYA's personality and behavior")
st.markdown("---")
...
st.markdown("**Preferred specialists (ARYA prioritizes these):**")
...
personality_choice = st.selectbox(
    "ARYA's personality style", options=personality_keys,
...
if st.button("💾 Save All Settings", type="primary", use_container_width=True):
    ...
    st.success("✅ Settings saved! ARYA will adapt to your preferences.")
    st.balloons()